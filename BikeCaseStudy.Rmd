...
```{r}
q2_2019 <- read_csv("~/BikeData/Divvy_Trips_2019_Q2.csv")
q3_2019 <- read_csv("~/BikeData/Divvy_Trips_2019_Q3.csv")
q4_2019 <- read_csv("~/BikeData/Divvy_Trips_2019_Q4.csv")
q1_2020 <- read_csv("~/BikeData/Divvy_Trips_2020_Q1.csv")
```
...
```
# Reassign to the desired values (we will go with the current 2020 labels: member and casual)
```{r}
all_trips <-  all_trips %>% 
...
write.csv(counts, file = "C:/Users/kanokpitr/OneDrive - OIC/Documents/avg_ride_length.csv")
write.csv(all_trips_v2, file = "C:/Users/kanokpitr/OneDrive - OIC/Documents/all_trips.csv")
```
